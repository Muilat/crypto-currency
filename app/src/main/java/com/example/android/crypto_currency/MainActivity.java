...
import com.example.android.crypto_currency.utilities.CryptoAdapter;
import com.example.android.crypto_currency.utilities.CryptoLoader;

import java.util.ArrayList;

public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Crypto>>, SharedPreferences.OnSharedPreferenceChangeListener{

//    String Github_url_string = "https://api.github.com/search/users?q=location:lagos+language:java";
//    static URL Github_REQUEST_URL;

    public static Crypto current_currency;
     ...
     */
    @Override
    public Loader<ArrayList<Crypto>> onCreateLoader(int id, Bundle args) {

        return new CryptoLoader(this);
    ...
    @Override
    public void onLoadFinished(Loader<ArrayList<Crypto>> loader, ArrayList<Crypto> data) {
    ...
    @Override
    public void onLoaderReset(Loader<ArrayList<Crypto>> loader) {

        updateUi(new ArrayList<Crypto>());
    }
    ...
    //update the ui after
    private void updateUi(final ArrayList<Crypto> currencies) {



        ListView listView = (ListView) findViewById(R.id.list_currency);

        CryptoAdapter cryptoAdapter = new CryptoAdapter(this,currencies);
...
//                startActivity(developerIntent);
        ...
        if(cryptoAdapter.isEmpty() || cryptoAdapter==null){
            TextView empty_view = (TextView)findViewById(R.id.empty_view);
            //make it visible
            empty_view.setVisibility(View.VISIBLE);
            listView.setEmptyView(findViewById(R.id.empty_view));
